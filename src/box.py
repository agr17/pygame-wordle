...
class Box():
    ...
    def draw(self, screen):
        ...
        if (self.state == EMPTY): block_color = BLACK
        elif (self.state == SUCCESS): block_color = GREEN
        elif (self.state == SEMI_SUCCESS): block_color = YELLOW
        elif (self.state == FAIL): block_color = GRAY
